...
class NvHostGpu : public ChannelBase {
  ...
  private:
    ...
    // Ioctls
    NvResult SubmitGpfifo(u64 gpfifo, u32 num_entries, InOut<hw::tegra_x1::gpu::GpfifoFlags, u32> inout_flags_and_detailed_error, InOutSingle<hw::tegra_x1::gpu::Fence> inout_fence, const hw::tegra_x1::gpu::GpfifoEntry* entries) override;
    ...
    NvResult AllocGpfifoEx(u32 num_entries, u32 num_jobs, u32 flags, hw::tegra_x1::gpu::Fence* out_fence, std::array<u32, 3> reserved) override;
};

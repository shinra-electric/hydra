...
// From Ryujinx (TODO: autogenerate from Switch config file)
std::map<std::string, SettingValue> nx_settings = {
    ...
    {"tc!tskin_rate_table_handheld",
     "[[-1000000, 40000, 0, 0], [36000, 43000, 51, 51], [43000, 48000, 51, "
     "102], [48000, 53000, 102, 153], [53000, 1000000, 153, 153], [48000, "
     "1000000, 153, 153]]"},
    {"tc!tskin_rate_table_console",
     "[[-1000000, 43000, 51, 51], [43000, 53000, 51, 153], [53000, 58000, 153, "
     "255], [58000, 1000000, 255, 255]]"},
    {"tc!rate_select", "both"},

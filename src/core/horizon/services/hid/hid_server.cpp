...
DEFINE_SERVICE_COMMAND_TABLE(
    ...
    StartSixAxisSensor, 79, SetGyroscopeZeroDriftMode, 100, SetSupportedNpadStyleSet, 101,
    GetSupportedNpadStyleSet, 102, SetSupportedNpadIdType, 103, ActivateNpad,
    106, AcquireNpadStyleSetUpdateEventHandle, 109, ActivateNpadWithRevision,
    120, SetNpadJoyHoldType, 122, SetNpadJoyAssignmentModeSingleByDefault, 124,

...
ENABLE_ENUM_FORMATTING(
    ...
    BGRA8Srgb, "bgra8srgb", RGB10A2Unorm, "rgb10a2unorm", RGB10A2Uint,
    "rgb10a2uint", RGBA8Unorm, "rgba8unorm", RGBA8Srgb, "rgba8srgb", RGBA8Snorm,
    "rgba8snorm", RGBA8Sint, "rgba8sint", RGBA8Uint, "rgba8uint", RG16Unorm,
    "rg16unorm", RG16Snorm, "rg16snorm", RG16Sint, "rg16sint", RG16Uint,
    "rg16uint", RG16Float, "rg16float", BGR10A2Unorm, "bgr10a2unorm",
    R11G11B10Float, "r11g11b10float", R32Sint, "r32sint", R32Uint, "r32uint",
    R32Float, "r32float", BGRX8Unorm, "bgrx8unorm", BGRX8Srgb, "bgrx8srgb",
    B5G6R5Unorm, "b5g6r5unorm", BGR5A1Unorm, "bgr5a1unorm", RG8Unorm,
    "rg8unorm", RG8Snorm, "rg8snorm", RG8Sint, "rg8sint", RG8Uint, "rg8uint",
    R16Unorm, "r16unorm", R16Snorm, "r16snorm", R16Sint, "r16sint", R16Uint,
    "r16uint", R16Float, "r16float", R8Unorm, "r8unorm", R8Snorm, "r8snorm",
    R8Sint, "r8sint", R8Uint, "r8uint", A8Unorm, "a8unorm", BGR5X1Unorm,
    "bgr5x1unorm", RGBX8Unorm, "rgbx8unorm", RGBX8Srgb, "rgbx8srgb",
